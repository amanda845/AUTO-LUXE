...
1. [Prerequisites](#-step-0-prerequisites-install-these-first)
2. [Project Setup](#-step-1-get-the-project-running-locally)
3. [Supabase Setup](#-step-2-supabase-setup-database--auth)
4. [Environment Variables](#-step-3-connect-your-app-to-supabase)
5. [Run Locally](#-step-4-run-the-app-locally)
6. [Deploy to Vercel](#-step-5-deploy-to-vercel)
7. [Push to GitHub](#-step-6-push-to-github)
8. [GitHub Workflow](#-step-7-how-to-work-with-github-daily)
